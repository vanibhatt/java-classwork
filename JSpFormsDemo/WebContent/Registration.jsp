...
<table>
	...
	<tr>
		...
		<td><input type="checkbox" name="Hobbies" value="dance"> Dance</td>
		<td><input type="checkbox" name="Hobbies" value="dance"> Music</td>
		<td><input type="checkbox" name="Hobbies" value="dance"> Sports</td>
		<td><input type="checkbox" name="Hobbies" value="dance"> Painting</td>
	</tr>
